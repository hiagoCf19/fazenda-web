...
export const WalletSummary = ({
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4  p-4 rounded-xl ">
      {/* Saldo Total */}
      <div className="flex-1 bg-zinc-50 rounded-lg p-4 shadow-sm">
      ...
      {/* Conta vinculada */}
      <div className="flex-1 bg-zinc-50 rounded-lg p-4 shadow-sm flex justify-between items-center">
        <div>
      ...
      <div className="flex-1 bg-zinc-50 rounded-lg p-4 shadow-sm flex items-center justify-center">
        <button
