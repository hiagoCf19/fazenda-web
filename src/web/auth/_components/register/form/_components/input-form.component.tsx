...
export function InputFormComponente({
  ...
  return (
    <div className="w-full mx-auto min-h-16 space-y-3">
      <div className="relative ">
        <Input
          {...register(name as any)}
          className=" h-[59px] w-[460px] border-secondary-foreground rounded-full pl-8 "
        />
      ...
      {errors[name as keyof typeof errors] ? (
        <p className="text-red-500 text-sm px-4 h-5">
